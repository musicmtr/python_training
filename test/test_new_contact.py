...
def test_new_contact(app):
    ...
    app.fill_contact_info(Contact(firstname="testname", middlename="testmidl", lastname="testlas", nickname="testnicl", title="testtit", company="testcomp",
...
def test_new_empty_contact(app):
    app.session.login(username="admin", password="secret")
    app.fill_contact_info(Contact(firstname="", middlename="", lastname="", nickname="", title="", company="",
